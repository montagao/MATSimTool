...
w_title = 'Current Divider Characteristics';
w_width = 800;
w_height = 800;
...
user_fns = {@currentdiveqn};


%Give brief description of the simulation 
info = cellstr(char('This plot demonstrates the basic principle of a current divider.',...
    'Notice that when R2 is approx 10x greater than R1, the voltage across it is approx. 10% of the source.'));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
