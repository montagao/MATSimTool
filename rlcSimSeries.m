function rlcSimSeries
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% USER SETUP HERE %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Properties of the window
w_title = 'RLC Series Circuit';
w_width = 800;
w_height = 800;

%properties of the main plot
p_title = 'Series RLC Circuit Response (Time Domain)';
y_label = 'Current Il';
x_label = 'Time (s)';
legendlabels = {'v', 'i'};
...
c_names = cellstr(char('Amplitude (Vs)'));
c_values = [1];
...
user_fns = {@rlceqnseries};

%Give brief description of the simulation 
info = cellstr(char('This plot demonstrates the different cases in RLC response. Try to adjust RLC values until you can identify all 3 cases. v(0) = 0, dv/dt(0) = 0'));
