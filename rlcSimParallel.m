function rlcSimParallel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% USER SETUP HERE %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Properties of the window
w_title = 'RLC Parallel Circuit';
w_width = 800;
w_height = 800;

%properties of the main plot
p_title = 'Parallel RLC Circuit Response (Time Domain)';
y_label = 'Current Il';
x_label = 'Time (s)';
legendlabels = {'Il', 'v'};
...
% e.g. 'rcStepResponse.png' if figure is placed in the fsame directory
fig_path = 'rlcParallelStep.png';
...
user_fns = {@rlceqnparallel};

%Give brief description of the simulation 
info = cellstr(char('This plot demonstrates the different cases in RLC response. Try to adjust RLC values until you can identify all 3 cases. Is(0) = 0, dIs/dt(0) = 0'));
...
diagramPlot = subplot('Position',[0.001, 0.62, 0.7, 0.4]);
