%@Author: Monta Gao
%@Updated: Nov. 27, 2016
function diodeBattery
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%% USER SETUP HERE %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Properties of the window
w_title = 'Diode as 2V source';
w_width = 800;
w_height = 800;

%properties of the main plot
p_title = 'Diode (IV) as 2V Source';
y_label = 'Voltage [V]';
x_label = 'R2 [Ohms]';
legendlabels = {'Vo'};
...
c_names = cellstr(char('V1 [V]','R1 [ohms]','Vt [V]', 'Is [A]'));
c_values = [5 50 25e-3 1e-15];
...
info = cellstr(char('This demonstrates the use of diodes as a voltage source. (In this case, it emulates approx. 2V).','Assume that the diodes have a forward voltage drop of 0.7V at 1mA'));
